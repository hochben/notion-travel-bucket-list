...
![The map, embedded at the top of the Notion page. Green is visited, blue is being planned, sand is on the wishlist.](img/map.png)
...
![The Destinations database in Notion. Each card is one trip, with its status, budget and travel month.](img/bucket-list.png)
...
| `img/` | The screenshots used in this README. |
| `README.md` | This file. |
